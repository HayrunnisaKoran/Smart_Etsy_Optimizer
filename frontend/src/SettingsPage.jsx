...
export default function SettingsPage() {
  ...
  // FIREBASE'DEN TÜM AYARLARI CANLI OKUMA
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(docRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        // Security
        setAccountEmail(data.accountEmail || 'hayrunnisa@gmail.com');
  ...
  // TÜM DEĞİŞİKLİKLERİ FIREBASE'E TEK SEFERDE KAYDETME
  ...
  return (
    <div className="p-10 space-y-8 animate-in fade-in duration-500">
      ...
      {/* SEKME SEÇİCİLER (Mizansen Bozulmadı) */}
      ...
      <div className="bg-white rounded-[3rem] border border-gray-50 shadow-sm p-10 min-h-[400px]">
        <form id="unified-settings-form" onSubmit={handleSaveChanges}>
          ...
          {/* --- API SETTINGS SEKMESİ (User Story 1 İsteri) --- */}
          {activeTab === 'api' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 animate-in fade-in duration-200">
              <div className="space-y-6">
